      ...
      <div class="col-md pt-5 border-left">
        <div class="ftco-footer-widget pt-md-5 mb-4">
         ...
         <div class="block-23 mb-3">
           <ul>
             <li><span class="icon fa fa-map-marker"></span><span class="text">Kuta Selatan, Badung, Bali, Indonesia</span></li>
             <li><a href="#"><span class="icon fa fa-paper-plane"></span><span class="text">hiddengemkutaselatan.com</span></a></li>
           </ul>
         </div>
       </div>
     </div>
